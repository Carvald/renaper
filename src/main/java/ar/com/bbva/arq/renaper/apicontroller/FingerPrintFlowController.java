...
public class FingerPrintFlowController {
	...
	public String fingerprintSubmit(RedirectAttributes attributes,
		...
		try {
			...
			attemptstRequestDTO.setRenaper(fingerPrintFlowCircuitDTO.getFingerPrintResponseDTO().getCode());
			fingerPrintFlowCircuitDTO.setAttemptstResponseVueltaDTO(renaperService.intentosDisponiblesSubmit(attemptstRequestDTO));
